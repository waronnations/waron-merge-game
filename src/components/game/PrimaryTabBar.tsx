...
export function PrimaryTabBar({
  ...
  return (
    <nav className="bottom-nav fixed bottom-0 left-0 right-0 z-40 border-t border-zinc-700/80 bg-zinc-950/98 shadow-[0_-8px_32px_rgba(0,0,0,0.45)] backdrop-blur-xl">
        ...
        {PRIMARY_TABS.map((t) => {
          ...
          return (
            ...
            >
              ...
              {badge > 0 && (
                <span className="absolute right-1 top-0 flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[9px] font-black text-black shadow">
                  {badge}
                </span>
              )}
            </button>
