  ...
  return (
    <div
      ...
      style={{
        ...
        background: "#050506",
        boxShadow:
          "inset 0 0 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.04)",
      }}
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: 2,
            background:
              "linear-gradient(to bottom, transparent 0%, #f97316 8%, #ffffff 50%, #a855f7 92%, transparent 100%)",
            boxShadow:
              "0 0 10px rgba(255,255,255,0.35), 0 0 20px rgba(249,115,22,0.35), 0 0 20px rgba(168,85,247,0.35)",
          }}
        />
      </div>
      ...
      {/* Low energy overlay with live timer */}
      {state.energy < ENERGY_PER_MERGE && (
        <div className="pointer-events-auto absolute inset-0 z-40 flex flex-col items-center justify-center rounded-2xl bg-black/80 backdrop-blur-[3px]">
          <div
            className="mb-3 h-9 w-9 animate-spin rounded-full border-2 border-sky-400/30 border-t-sky-400"
            aria-hidden
          />
          ...
          {regenSeconds > 0 && (
            <div className="mt-2 rounded-full bg-sky-500/15 px-3 py-1 text-[11px] font-bold tabular-nums text-sky-300">
              +1⚡ in {regenSeconds}s
            </div>
          )}
